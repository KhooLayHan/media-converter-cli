...
/**
 * Service responsible for orchestrating file conversion operations.
 * This class contains the core business logic separated from CLI concerns.
 */
public class ConversionService {
	 ...
	 */
	public ConversionResult convert(File inputFile, File outputFile) throws ConversionException, UnsupportedFormatException {
		logger.info("Starting conversion: {} -> {}", inputFile.getAbsolutePath(), outputFile.getAbsolutePath());
