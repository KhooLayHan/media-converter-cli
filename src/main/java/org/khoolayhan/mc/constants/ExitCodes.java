...
/**
 * Defines standard exit codes for the Media Converter application.
 * Following Unix convention where 0 indicates success and non-zero indicates various failures.
 */
