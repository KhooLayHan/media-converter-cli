...
public class MediaConverter implements Runnable {
    ...
    @CommandLine.Option(names = {"-i", "--input"}, required = true, description = "The input file to convert.")
    private File inputFile;

    @CommandLine.Option(names = {"-o", "--output"}, required = true, description = "The output file.")
