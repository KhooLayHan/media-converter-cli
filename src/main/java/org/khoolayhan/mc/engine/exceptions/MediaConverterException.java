...
/**
 * Base exception class for all Media Converter related exceptions. This provides a common parent
 * for all custom exceptions in the application, making exception handling more structured and
 * maintainable.
 */
